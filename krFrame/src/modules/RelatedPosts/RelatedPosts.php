...
class RelatedPosts
{
  ...
  private function prepareData() {
    ...
    } else if ($args['post_type'] == 'post' && isset($this->values['categoryID']) && $this->values['categoryID'] != '')
      $args['cat'] = $this->values['categoryID'];
    else if ($args['post_type'] == 'page' && isset($this->values['categoryID']) && $this->values['categoryID'] != '')
