                            ...
                            <div class="krShowTab krClearFix">
                                <p>
                                    ...
                                    <select id="<?php echo $obj->get_field_id('gridXl'); ?>" name="<?php echo $obj->get_field_name('gridXl'); ?>">
                                        <?php for($numGrid = 12; $numGrid>=1; $numGrid--) { ?>
                                            <option <?php selected($instance['gridXl'], 'col-xl-'.$numGrid);?> value="col-xl-<?php echo $numGrid;?>"><?php echo round((100 * $numGrid) / 12, 2).'% - '.$numGrid;?> </option>
                                        <?php } ?>
                                    </select>
                                ...
                                <p>
                                    ...
                                    <select id="<?php echo $obj->get_field_id('gridLg'); ?>" name="<?php echo $obj->get_field_name('gridLg'); ?>">
                                        <?php for($numGrid = 12; $numGrid>=1; $numGrid--) { ?>
                                            <option <?php selected($instance['gridLg'], 'col-lg-'.$numGrid);?> value="col-lg-<?php echo $numGrid;?>"><?php echo round((100 * $numGrid) / 12, 2).'% - '.$numGrid;?> </option>
                                        <?php } ?>
                                    </select>
                                ...
                                <p>
                                    ...
                                    <select id="<?php echo $obj->get_field_id('gridMd'); ?>" name="<?php echo $obj->get_field_name('gridMd'); ?>">
                                        <?php for($numGrid = 12; $numGrid>=1; $numGrid--) { ?>
                                            <option <?php selected($instance['gridMd'], 'col-md-'.$numGrid);?> value="col-md-<?php echo $numGrid;?>"><?php echo round((100 * $numGrid) / 12, 2).'% - '.$numGrid;?> </option>
                                        <?php } ?>
                                    </select>
                                ...
                                <p>
                                    ...
                                    <select id="<?php echo $obj->get_field_id('gridSm'); ?>" name="<?php echo $obj->get_field_name('gridSm'); ?>">
                                        <?php for($numGrid = 12; $numGrid>=1; $numGrid--) { ?>
                                            <option <?php selected($instance['gridSm'], 'col-sm-'.$numGrid);?> value="col-sm-<?php echo $numGrid;?>"><?php echo round((100 * $numGrid) / 12, 2).'% - '.$numGrid;?> </option>
                                        <?php } ?>
                                    </select>
                                ...
                                <p>
                                    ...
                                    <select id="<?php echo $obj->get_field_id('gridXs'); ?>" name="<?php echo $obj->get_field_name('gridXs'); ?>">
                                        <?php for($numGrid = 12; $numGrid>=1; $numGrid--) { ?>
                                            <option <?php selected($instance['gridXs'], 'col-'.$numGrid);?> value="col-<?php echo $numGrid;?>"><?php echo round((100 * $numGrid) / 12, 2).'% - '.$numGrid;?> </option>
                                        <?php } ?>
                                    </select>
